...
ggplot(null_data, aes(fill = significance, y = value, x = years)) + geom_bar(position="fill", stat="identity") + ggtitle("Missing Values by Years and Significance")  + theme(plot.title = element_text(hjust = 0.5))
```
